...
VBA Challenge Excel file: [VBA Challenge - Stock Analysis](https://github.com/awalindeep/Stock-Analysis/blob/main/Resources/VBA_Challenge.xlsm)
...
Code refactoring can be defined as continuous improvement of the code by different methods to make it better and efficient. There are several pros and cons of refactoring codes.
